...
| Security headers, rate limiting | `@composable-svelte/core/ssr/middleware` | `composable-svelte-ssr` |
| HTML sanitization (needs the `isomorphic-dompurify` optional peer) | `@composable-svelte/core/ssr/sanitize` | `composable-svelte-ssr` |
