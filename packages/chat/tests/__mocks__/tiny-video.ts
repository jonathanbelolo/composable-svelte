...
/**
 * A second, different video — same recipe, white instead of black.
 *
 * Needed because the components key their load state on `attachment.url`: a
 * swap to a different attachment carrying the *same* URL is deliberately not a
 * new load, so a test of swap behaviour needs two genuinely different sources.
 */
export const OTHER_TINY_VIDEO = 'data:video/webm;base64,';
