...
> verification**, **password recovery**, **MFA** (challenge and enrolment) and
> **OAuth** (redirect and callback) — headless flows, HTTP adapter and styled
> components. What does not exist yet: token refresh, account linking, and MFA
> management — disabling it or regenerating recovery codes, which need an
