...
export type CodeHighlightAction = {
    ...
    type: 'highlightLinesChanged';
    lines: number[];
} | {
    type: 'highlighted';
    html: string;
} | {
    type: 'highlightFailed';
    error: string;
};
/**
 ...
 */
export declare function createInitialState(config?: Partial<CodeHighlightState>): CodeHighlightState;
//# sourceMappingURL=code-highlight.types.d.ts.map