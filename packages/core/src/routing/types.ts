 ...
 * ```
 */
export interface RouteConfig<Dest extends { type: string; state: any }, Action> {
	/**
...
export type Serializer<
	Dest extends { type: string; state: any },
	Type extends DestinationType<Dest>
> = (state: DestinationState<Dest, Type>) => string;
 ...
 * ```
 */
export type Parser<Dest extends { type: string; state: any }> = (path: string) => Dest | null;
 ...
 * ```
 */
export type DestinationToActionMapper<
	Dest extends { type: string; state: any },
	Action
> = (destination: Dest | null) => Action | null;
