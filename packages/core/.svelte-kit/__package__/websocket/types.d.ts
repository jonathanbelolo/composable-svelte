...
export type WebSocketEvent = WebSocketConnectedEvent | WebSocketDisconnectedEvent | WebSocketErrorEvent | WebSocketReconnectingEvent | WebSocketReconnectedEvent;
...
export declare class WebSocketError extends Error {
    ...
    constructor(message: string, code: string | null, recoverable: boolean, cause?: unknown | undefined);
}
export declare const WS_ERROR_CODES: {
    readonly CONNECTION_FAILED: "WS_CONNECTION_FAILED";
    readonly CONNECTION_TIMEOUT: "WS_CONNECTION_TIMEOUT";
    readonly SEND_FAILED: "WS_SEND_FAILED";
    readonly INVALID_MESSAGE: "WS_INVALID_MESSAGE";
    readonly MAX_RECONNECTS: "WS_MAX_RECONNECTS";
    readonly PROTOCOL_ERROR: "WS_PROTOCOL_ERROR";
...
export declare const JSONSerializer: MessageSerializer;
