...
import type { WebSocketClient, WebSocketEvent, WebSocketMessage } from './types.js';
 ...
 * ```
 */
export declare function connect<Action>(client: WebSocketClient, subscriptionId: string, url: string, protocols?: string[], onEvent?: (event: WebSocketEvent) => Action): EffectType<Action>;
/**
 ...
 * ```
 */
export declare function disconnect<Action>(client: WebSocketClient, code?: number, reason?: string): EffectType<Action>;
/**
 ...
 * ```
 */
export declare function send<T, Action>(client: WebSocketClient<T>, message: T, onSuccess?: () => Action, onFailure?: (error: WebSocketError) => Action): EffectType<Action>;
/**
 ...
 * ```
 */
export declare function subscribe<T, Action>(client: WebSocketClient<T>, subscriptionId: string, onMessage: (message: WebSocketMessage<T>) => Action): EffectType<Action>;
/**
 ...
 * ```
 */
export declare function subscribeToEvents<Action>(client: WebSocketClient, subscriptionId: string, onEvent: (event: WebSocketEvent) => Action): EffectType<Action>;
...
//# sourceMappingURL=effect-websocket.d.ts.map