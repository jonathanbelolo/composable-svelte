 ...
 */
function getSpringConfig(preset, override) {
 ...
 */
export async function animateModalIn(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.modal, springConfig);
        await motionAnimate(element, {
            opacity: [0, 1],
            scale: [0.95, 1],
 ...
 * Preserves CSS translate(-50%, -50%) for centering by composing transforms.
 */
export async function animateModalOut(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.modal, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0],
 ...
 */
export async function animateBackdropIn(element) {
    try {
        const config = getSpringConfig(springPresets.modal);
        await motionAnimate(element, { opacity: [0, 1] }, {
            type: 'spring',
            visualDuration: config.visualDuration,
            bounce: config.bounce
        }).finished;
 ...
 */
export async function animateBackdropOut(element) {
    try {
        const config = getSpringConfig(springPresets.modal);
        await motionAnimate(element, { opacity: [1, 0] }, {
            type: 'spring',
            visualDuration: config.visualDuration,
            bounce: config.bounce
        }).finished;
 ...
 */
export async function animateSheetIn(element, side = 'bottom', springConfig) {
    try {
 ...
 */
export async function animateSheetOut(element, side = 'bottom', springConfig) {
    try {
        const config = getSpringConfig(springPresets.sheet, springConfig);
        const transform = side === 'bottom'
            ? { y: ['0%', '100%'] }
 ...
 */
export async function animateDrawerIn(element, side = 'left', springConfig) {
    try {
 ...
 */
export async function animateDrawerOut(element, side = 'left', springConfig) {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0],
 ...
 * Preserves CSS translate(-50%, -50%) for centering by composing transforms.
 */
export async function animateAlertIn(element, springConfig) {
    try {
 ...
 * Preserves CSS translate(-50%, -50%) for centering by composing transforms.
 */
export async function animateAlertOut(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.alert, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0],
 ...
 */
export async function animateTooltipIn(element, springConfig) {
    try {
 ...
 */
export async function animateTooltipOut(element) {
    try {
 ...
 */
export async function animateToastIn(element, springConfig) {
    try {
 ...
 */
export async function animateToastOut(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.toast, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0],
 ...
 */
export async function animateDropdownIn(element) {
    try {
 ...
 * @returns Promise that resolves when animation completes (or fails gracefully)
 */
export async function animateDropdownOut(element) {
    try {
        const config = getSpringConfig(springPresets.tooltip);
        await motionAnimate(element, {
            opacity: [1, 0]
 ...
 */
export async function animateSidebarExpand(element, targetWidth, springConfig, side = 'left') {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
 ...
 */
export async function animateSidebarCollapse(element, currentWidth, springConfig, side = 'left') {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
 ...
 */
export async function animatePopoverIn(element, positionTransform = '', springConfig) {
    try {
 ...
 * Preserves positioning transforms (translateX/translateY) by composing them.
 */
export async function animatePopoverOut(element, positionTransform = '', springConfig) {
    try {
        const config = getSpringConfig(springPresets.popover, springConfig);
        // Compose positioning transform with scale
 ...
 */
export async function animateStackPushIn(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
        await motionAnimate(element, {
            opacity: [0, 1],
 ...
 */
export async function animateStackPushOut(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0.7],
 ...
 */
export async function animateStackPopOut(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
        await motionAnimate(element, {
            opacity: [1, 0],
 ...
 */
export async function animateStackPopIn(element, springConfig) {
    try {
        const config = getSpringConfig(springPresets.drawer, springConfig);
        await motionAnimate(element, {
            opacity: [0.7, 1],
 ...
 * @returns Promise that resolves when animation completes (or fails gracefully)
 */
export async function animateAccordionExpand(element) {
    try {
        // Set initial state
 ...
 * @returns Promise that resolves when animation completes (or fails gracefully)
 */
export async function animateAccordionCollapse(element) {
    try {
        // Get current height
