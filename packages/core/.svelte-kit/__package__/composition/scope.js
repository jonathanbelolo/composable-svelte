 ...
 * ```
 */
export function scope(toChildState, fromChildState, toChildAction, fromChildAction, childReducer) {
 ...
 * ```
 */
export function scopeAction(toChildState, fromChildState, actionType, childReducer) {
    return scope(toChildState, fromChildState, (action) => (action.type === actionType && 'action' in action ? action.action : null), (childAction) => ({ type: actionType, action: childAction }), childReducer);
}
