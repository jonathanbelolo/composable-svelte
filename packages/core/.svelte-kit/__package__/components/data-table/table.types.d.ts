 ...
 */
export type FilterOperator = 'equals' | 'notEquals' | 'contains' | 'notContains' | 'startsWith' | 'endsWith' | 'greaterThan' | 'lessThan' | 'greaterThanOrEqual' | 'lessThanOrEqual' | 'in' | 'notIn';
/**
...
export interface TableConfig<T> {
     ...
     */
    fetchData?: (state: TableState<T>) => Promise<{
        data: T[];
        total: number;
    }>;
}
