 ...
 */
export declare function createInitialCarouselState<T = unknown>(slides?: CarouselSlide<T>[], initialIndex?: number, loop?: boolean, autoPlayInterval?: number): CarouselState<T>;
