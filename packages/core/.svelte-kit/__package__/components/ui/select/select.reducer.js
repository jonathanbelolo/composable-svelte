 ...
 * ```
 */
export const selectReducer = (state, action, deps) => {
    switch (action.type) {
        case 'opened': {
            return [
                {
        ...
        case 'arrowUp': {
            ...
            const prevIndex = state.highlightedIndex === -1
        ...
        case 'end': {
            ...
            const lastIndex = findNextEnabledIndex(state.filteredOptions, state.filteredOptions.length, 'up');
            return [
                {
                    ...state,
