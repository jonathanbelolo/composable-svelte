...
export type ComboboxAction<T = string> = {
    ...
    type: 'openingCompleted';
} | {
    type: 'closed';
} | {
    type: 'closingCompleted';
} | {
    type: 'toggled';
} | {
    type: 'optionSelected';
 ...
 */
export declare function createInitialComboboxState<T = string>(options?: ComboboxOption<T>[], initialValue?: T | null, debounceDelay?: number): ComboboxState<T>;
