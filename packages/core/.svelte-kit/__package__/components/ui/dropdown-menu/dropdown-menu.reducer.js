 ...
 * ```
 */
export const dropdownMenuReducer = (state, action, deps) => {
    switch (action.type) {
        case 'opened': {
            return [
                {
        ...
        case 'arrowDown': {
            ...
            const nextIndex = findNextEnabledIndex(state.items, state.highlightedIndex, 'down');
            return [
                {
                    ...state,
        ...
        case 'arrowUp': {
            ...
            const prevIndex = findNextEnabledIndex(state.items, state.highlightedIndex, 'up');
            return [
                {
                    ...state,
