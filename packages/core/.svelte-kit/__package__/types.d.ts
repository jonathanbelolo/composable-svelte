 ...
 * @template Action - The action type
 */
export type EffectExecutor<Action> = (dispatch: Dispatch<Action>) => void | Promise<void>;
/**
...
export type Effect<Action> = {
    ...
    readonly _tag: 'FireAndForget';
    readonly execute: () => void | Promise<void>;
} | {
    readonly _tag: 'Batch';
    readonly effects: readonly Effect<Action>[];
} | {
    readonly _tag: 'Cancellable';
    readonly id: string;
    readonly execute: EffectExecutor<Action>;
} | {
    readonly _tag: 'Debounced';
    readonly id: string;
    readonly ms: number;
    readonly execute: EffectExecutor<Action>;
} | {
    ...
    readonly _tag: 'AfterDelay';
    readonly ms: number;
    readonly execute: EffectExecutor<Action>;
} | {
    readonly _tag: 'Subscription';
    readonly id: string;
    readonly setup: SubscriptionSetup<Action>;
};
/**
 ...
 * ```
 */
export type Reducer<State, Action, Dependencies = any> = (state: State, action: Action, dependencies: Dependencies) => readonly [State, Effect<Action>];
/**
 ...
 * ```
 */
export type Middleware<State, Action> = (store: MiddlewareAPI<State, Action>) => (next: Dispatch<Action>) => Dispatch<Action>;
