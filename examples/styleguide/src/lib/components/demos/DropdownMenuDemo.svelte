...
<div class="space-y-12">
	...
	<section class="space-y-6">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			...
			<div class="rounded-lg border bg-card p-6 space-y-3">
				<div class="text-2xl">🎯</div>
				<h3 class="font-semibold">Smart Item Handling</h3>
				<p class="text-sm text-muted-foreground">
			...
			<div class="rounded-lg border bg-card p-6 space-y-3">
				<div class="text-2xl">🎨</div>
				<h3 class="font-semibold">Rich Customization</h3>
				<p class="text-sm text-muted-foreground">
	...
	<section class="space-y-6">
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
			<div class="rounded-lg border bg-card p-6 space-y-3">
				<h3 class="font-semibold">Context Menus</h3>
				<p class="text-sm text-muted-foreground">
			...
			<div class="rounded-lg border bg-card p-6 space-y-3">
				<h3 class="font-semibold">Toolbar Menus</h3>
				<p class="text-sm text-muted-foreground">
			...
			<div class="rounded-lg border bg-card p-6 space-y-3">
				<h3 class="font-semibold">User Menus</h3>
				<p class="text-sm text-muted-foreground">
	...
	<section class="space-y-6">
		...
		<div class="space-y-4">
			<div class="rounded-lg border bg-card p-6">
				<h3 class="font-semibold mb-3">When to Use Dropdown Menus</h3>
	...
	<section class="space-y-6">
		<div>
			<h2 class="text-xl font-semibold mb-2">Animation System</h2>
		</div>
